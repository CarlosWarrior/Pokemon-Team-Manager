...
@Component({
  selector: 'app-pokemon-bulk-create',
  templateUrl: './pokemon-bulk-create.component.html',
  styleUrls: ['./pokemon-bulk-create.component.scss']
})
export class PokemonBulkCreateComponent {
  constructor( public dialogRef: MatDialogRef<PokemonBulkCreateComponent>,){}
